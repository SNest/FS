namespace FlyingShapes
{
    ...
    partial class Main
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.langListBox.Items.AddRange(
                new object[]
                    {
                        resources.GetString("langListBox.Items"), resources.GetString("langListBox.Items1"), 
            ...
            this.mainTreeView.Nodes.AddRange(
                new[] { (System.Windows.Forms.TreeNode)(resources.GetObject("mainTreeView.Nodes")) });
